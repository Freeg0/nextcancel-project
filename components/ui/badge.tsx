  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        gold: "border-transparent bg-yellow-500 text-zinc-900",
        silver: "border-transparent bg-zinc-400 text-zinc-900",
        bronze: "border-transparent bg-orange-600 text-zinc-50",
      },
    },
    defaultVariants: {
      variant: "default",
